    ...
    <div id="feedback_1" class="background">
        <div class="bcg">
            <div class="hsContainer">
                ...
                <form id="form" method="post" action="http://mercury.ict.swin.edu.au/it000000/demos/showpost.php" onsubmit="checkform()">
                    <fieldset>
                    <fieldset>
                   ...
                   <fieldset>
                        <label>Gender</label> 
                        <br />
                        <label for="gender_female">Female</label><input type="radio" id="gender_female" name="gender" value="female" checked="checked" />
                    ...
                    <button name="submit" value="Submit" onclick="return checkform()"  >Submit</button>
                    </fieldset>
                </form>
