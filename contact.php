...
<body onload="applyStyle()">
    ...
    <div id="content">
    <!-- Section #1 -->
    <div id="contact_1" class="background">
        <div class="bcg">
            <div class="hsContainer">
				...
				<table>
				    <tr>
				        <td rowspan="3" ><p>Contact information:</p></td>
				        <td><p>Phone:</p></td>
				        <td><p>012-3456789</p></td>
				    </tr>
				    <tr>
				        <td><p>Fax:</p></td>
				        <td><p>082-333444</p></td>
				    </tr>
				    <tr>
				        <td><p>Mail:</p></td>
				        <td><a href="mailto:contact@friendshippark.com" >contact@friendshippark.com</a></td>
				    </tr>
				    <tr>
				        <td><p>Address:</p></td>
				        <td colspan="2" ><p>Jalan Song, Lorong Song 3C4, 93350 Kuching, Sarawak, Malaysia.</p></td>
				    </tr>
				</table>
				</div>				
                </div>
