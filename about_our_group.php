...
<body onload="applyStyle()">
    ...
    <div id="content">
    <!-- Section #1 -->
    <div id="profile_1" class="background">
        <div class="bcg">
            <div class="lsContainer">
                <div class="lsContent">
                <!-- Your content here -->
				<ul>
					<li>Name: Timothy Kiyui</li>
					<li>ID: 4316886</li>
    ...
    <!-- Section #2 -->
    <div id="profile_2" class="background">
        <div class="bcg">
            <div class="rsContainer">
                <div class="rsContent">
                <!-- Your content here -->
				<ul>
					<li>Name: Jason Chew</li>
					<li>ID: 4304373</li>
    ...
    <!-- Section #3 -->
    <div id="profile_3" class="background">
        <div class="bcg">
            <div class="lsContainer">
                <div class="lsContent">
                <!-- Your content here -->
					<ul>
					<li>Name: Brian Sim</li>
					<li>ID: 4316878</li>
