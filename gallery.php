...
<body onload="applyStyle()">
    ...
    <div id="content">
    <!-- Section #1 -->
    <div id="gallery_1" class="background">
        <div class="bcg">
            <div class="lsContainer">
                <div class="lsContent">
                <!-- All photos credits got to Hurairah (WAI) -->
                <p>All photo credits go to <a href="photographs.html" >Hurairah (WAI)</a>.</p>
                </div>
            </div>
        </div>
    </div>
    <!-- Section #2 -->
    <div id="gallery_2" class="background">
        <div class="bcg">
            <div class="gContainer">
                <div class="gContent">
                <p onclick="nextImg()" id="imgNext" >Next</p>                
                <p onclick="prevImg()" id="imgPrev" >Previous</p>
                <p><a href="./images/001.jpg" id="viewImage" >View</a></p>
                </div>
            </div>
        </div>
    </div>
