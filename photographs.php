...
<body onload="applyStyle()">
    ...
    <div id="content">
    <!-- Section #1 -->
    <div id="photo_1" class="background">
        <div class="bcg">
            <div class="inContainer">
                <div class="inContent">
                <!-- Your content here -->
                <h2>Hurairah (WAI)</h2>
                <img src="./images/035.jpg" alt="Hurairah" width="50%" height="50%" />
                <p>Our awesome and beloved photographer. Contact him via Facebook&#169; <a href="https://www.facebook.com/Photo.Maniac.Wai?fref=ufi" >here</a>.</p>
                </div>
            </div>
        </div>
    </div>
